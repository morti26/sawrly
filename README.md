...
The repository root contains the Next.js app and backend.
The Flutter mobile app now lives as a sibling folder in the shared workspace:

```text
sawrly/
|- sawrly-web/    Next.js + PostgreSQL backend
\- sawrly-mobile/ Flutter mobile app
```
