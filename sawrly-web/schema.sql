...
-- 21. CREATOR WALLET PAYOUTS
-- Creator earnings are derived from confirmed payments. This table records money
-- actually sent out by the platform so the balance remains auditable.
