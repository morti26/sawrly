...
const DEFAULT_SUPERADMIN_EMAIL = 'mon24@live.se';
...
export default function UsersTable({ role }: UsersTableProps) {
    ...
    const canManageUsers =
        currentAdminRole === 'admin' || isCurrentUserSuperAdmin;
    ...
    useEffect(() => {
        try {
            ...
            const hasSuperAdminAccess =
                parsed?.is_superadmin === true || normalizedEmail === DEFAULT_SUPERADMIN_EMAIL;
            setIsCurrentUserSuperAdmin(hasSuperAdminAccess);
        } catch {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isEditing && isCurrentUserSuperAdmin) {
