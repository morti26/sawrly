...
export default function AdminLevelsPage() {
    return (
        <div className="space-y-6">
            ...
            <div className="bg-surface-card p-6 rounded shadow space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="rounded-lg border border-m3-outline-variant/60 p-4">
                        <div className="flex items-center justify-end gap-2">
                            <div className="text-lg">🥈</div>
                            <div className="text-right font-bold">مميز</div>
                        </div>
                        <ul className="mt-3 space-y-1 text-right text-sm text-m3-on-surface">
