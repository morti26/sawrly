    ...
    return (
        <div dir="rtl" className="space-y-6">
            <div>
                ...
                <p className="text-sm text-m3-on-surface-variant">نظرة سريعة على الطلبات والمدفوعات والمشاريع والبلاغات المفتوحة.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">المشاريع النشطة</h3>
                ...
                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">الطلبات المعلقة</h3>
                    <p className="text-3xl font-bold">{overview.pendingQuotes}</p>
                    <p className="text-xs text-m3-outline mt-2">طلبات بانتظار الانتقال إلى الخطوة التالية في مسار الحجز.</p>
                </div>

                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">المدفوعات المعلقة</h3>
                ...
                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">إيراد هذا الشهر</h3>
                ...
                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">البلاغات المفتوحة</h3>
                ...
                <div className="p-6 border rounded bg-surface-card shadow-sm">
                    <h3 className="text-m3-on-surface-variant text-sm">تكامل الدفع الخارجي</h3>
                    ...
                    <p className="text-xs text-m3-outline mt-2">
